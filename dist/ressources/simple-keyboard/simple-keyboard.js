          ...
          (e = [
              ...
              value: function (t, e, n, o) {
                ...
                return (
                  ("{bksp}" === t || "{backspace}" === t) && s.length > 0
                    ? (s = this.removeAt(s, n, o))
                    : "{space}" === t
                    ? (s = this.addStringAt(s, " ", n, o))
                    : "{tab}" !== t ||
                    ...
                    ? ("{enter}" !== t && "{numpadenter}" !== t) ||
                      ...
                      ? t.includes("numpad") &&
                        ...
                        ? (s = this.addStringAt(s, t[t.length - 2], n, o))
                        : "{numpaddivide}" === t
                        ? (s = this.addStringAt(s, "/", n, o))
                        : "{numpadmultiply}" === t
                        ? (s = this.addStringAt(s, "*", n, o))
            ...
            },
            {
              ...
              value: function (t, e, n, o) {
                ...
                return (
                  n || 0 === n
                    ? ((i = [t.slice(0, n), e, t.slice(n)].join("")),
                      this.isMaxLengthReached() ||
                        (o && this.updateCaretPos(e.length)))
                    : (i = t + e),
                  i
                );
              },
                ...
                return (
                  e && e >= 0
                    ? t.substring(e - 2, e).match(i)
                      ? ((o = t.substr(0, e - 2) + t.substr(e)),
                        n && this.updateCaretPos(2, !0))
                      : ((o = t.substr(0, e - 1) + t.substr(e)),
                        n && this.updateCaretPos(1, !0))
                    : t.slice(-2).match(i)
      ...
      var i = (function () {
        function PhysicalKeyboard(t) {
          ...
          !(function (t, e) {
            ...
            (this.dispatch = e),
            (this.getOptions = n),
            o.bindMethods(PhysicalKeyboard, this);
        }
        var t, e, n;
        return (
          (t = PhysicalKeyboard),
                ...
                this.dispatch(function (t) {
                  ...
                  o &&
                    ((o.style.backgroundColor =
                      e.physicalKeyboardHighlightBgColor || "#9ab4d0"),
                    (o.style.color =
                      e.physicalKeyboardHighlightTextColor || "white"));
                });
              },
            },
            {
      ...
      var s = (function () {
        function SimpleKeyboard() {
          ...
          Keyboard_classCallCheck(this, SimpleKeyboard),
            _defineProperty(this, "handleParams", function (t) {
              var e, n, o;
          ...
          if (
            ...
            o.bindMethods(SimpleKeyboard, this),
            (this.input = {}),
            ...
            throw (
              (console.warn('".'.concat(r, '" was not found in the DOM.')),
              ...
              value: function () {
                ...
                Array.isArray(this.options.modules) &&
                  (this.options.modules.forEach(function (e) {
                    ...
                    if (
                      n.constructor.name &&
                      "Function" !== n.constructor.name
                    ) {
                      var o = "module-".concat(
                        t.utilities.camelCase(n.constructor.name)
                      );
                      t.keyboardPluginClasses =
                        t.keyboardPluginClasses + " ".concat(o);
                    }
                    n.init(t);
                  }),
                  (this.keyboardPluginClasses =
