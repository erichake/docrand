    ...
    setLevel(o) {
        const INP = function (kbd) {
            let inp = $.input()
                ...
                .stl(`background:#b8def6;font-size:28px;width:100px;margin-left:5px;margin-right:5px;border-radius:8px;border:0;text-align:center;outline:none;padding-left:10px;padding-right:10px`);
        ...
        let wrp = $.div()
            ...
            .stl(`position:relative;padding-top:10px;padding-bottom:10px;display:table;left:50%;transform:translate(-50%,0);font-size:28px;font-family:sans-serif;color:white`);
        let pre = $.div()
            .inner($.TeX(p))
        ...
        switch (o.type()) {
            ...
            case "int":
            case "dec":
                inp = INP(o.type() === "int" ? int_kbd : dec_kbd).stl(`display:table-cell;vertical-align:middle;margin-left:5px;margin-right:5px;margin-top:3px`);
                // .kup((e) => {
                ...
                break;
            case "min-s":
                inp1 = INP(int_kbd).stl(`display:table-cell;margin-left:5px;margin-right:5px;width:60px`);
                inp2 = INP(int_kbd).stl(`display:table-cell;margin-left:5px;margin-right:5px;width:60px`);
                min = $.div()
            ...
            case "h-min-s":
                inp1 = INP(int_kbd).stl(`display:table-cell;margin-left:5px;margin-right:5px;width:60px`);
                inp2 = INP(int_kbd).stl(`display:table-cell;margin-left:5px;margin-right:5px;width:60px`);
                inp3 = INP(int_kbd).stl(`display:table-cell;margin-left:5px;margin-right:5px;width:60px`);
                h = $.div()
                    .stl("display:table-cell;vertical-align:middle;padding-right:10px")
                    .inner($.TeX(`$$h$$`));
                min = $.div()
            ...
            case "puiss10":
                ten = $.div()
                    ...
                    .inner($.TeX(`$$10$$`));
                inp2 = INP(int_kbd).stl(`display:block;margin-left:5px;margin-right:5px;font-size:24px;width:60px`);
                inp2wrp = $.div()
                    .stl(`display:table-cell;margin-left:5px;margin-right:5px;vertical-align:middle`)
                    .add(inp2)
                ...
                break;
            case "puiss":
                inp1 = INP(dec_kbd).stl(`display:block;margin-left:5px;margin-right:5px;margin-bottom:5px;width:60px`);
                inp1wrp = $.div()
                ...
                inp2wrp = $.div()
                    .stl(`display:table-cell;margin-left:5px;margin-right:5px;vertical-align:top;`)
                    .add(inp2)
                    .add($.div().stl(`display:block;height:50px`));
                o.addinput(inp1).addinput(inp2);
                this.dom()
            ...
            case "sci":
                ...
                inp1wrp = $.div()
                    .stl(`display:table-cell;vertical-align:middle;margin-left:5px;margin-right:5px`)
                    .add(inp1);
                inp2 = INP(int_kbd).stl(`display:block;margin-left:5px;margin-right:5px;margin-bottom:8px;font-size:24px;width:40px`);
                inp2wrp = $.div()
