    ...
    setLevel(o) {
        ...
        const INP = function (kbd) {
            let inp = $.input()
                ...
                .stl(`background:#b8def6;font-size:28px;width:${o.input_width()}px;margin-left:5px;margin-right:5px;border-radius:8px;border:0;text-align:center;outline:none;padding-left:10px;padding-right:10px`);
            inp.getValue().KBDS = kbd;
            return inp;
        };
        const pack = function (dm) {
            return $.div()
        ...
        let wrp = $.div()
            ...
            .stl(`position:relative;padding-top:10px;padding-bottom:10px;display:${foot.length === 0 ? "none" : "table"};left:50%;transform:translate(-50%,0);font-size:28px;font-family:sans-serif;color:white`);
