...
export const $PREFS = {
    ...
    content: {
        ...
        you_fail: {
            ...
            transition_time: 0.2,
            comment1: "Votre expression est mal écrite :<br>il y a des erreurs de syntaxe !",
            comment2: "Votre expression est correcte, mais elle n'est pas réduite : elle devrait être sans parenthèse !",
    ...
    footer: {
        ...
        comment2: "Entrer une liste de nombres entiers séparés par des points-virgules :",
    },
};
